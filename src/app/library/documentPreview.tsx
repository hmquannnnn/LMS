...
const DocumentPreview = ({ props }) => {
    ...
    return (
        ...
        <div className={`w-full flex gap-[4vw] h-full  ${props?.isOddIndex ? 'flex-row-reverse' : 'flex-row'}`}>
            ...
            <div className='mt-4 w-[55%] flex flex-col'>
                ...
                <div className='flex-1 flex items-end'>
                    ...
                    <div className={`flex flex-1 w-full gap-5 items-stretch  ${props.isOddIndex ? 'justify-end' : 'justify-start'}`}>
                        <div>

                            <div className='max-w-[200px] h-full shadow-[rgba(0,0,0,0.15)_3px_3px_7px_1px] bg-purple_2 px-4 py-4 rounded-2xl cursor-pointer hover:shadow-[rgba(0,0,0,0.3)_3px_3px_7px_1px]' onClick={() => isLiked ? onUnLike() : onLike()}>
                                <div className='mb-2'>
                        ...
                        <div>
                            <Dropdown menu={{ items: practiceItems }} placement="bottom" >
                                <div className='max-w-[200px] h-full shadow-[rgba(0,0,0,0.15)_3px_3px_7px_1px] sha px-4 py-4 rounded-2xl cursor-pointer hover:shadow-[rgba(0,0,0,0.3)_3px_3px_7px_1px]'>
                                    <div className='mb-2'>
                                        <PracticeIcon />
                                    </div>
