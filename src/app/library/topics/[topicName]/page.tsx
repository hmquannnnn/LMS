...
import { callGetDocumentsWithPaging } from "@/apis/documentsAPI";
...
const TopicDetailPage = (props: any) => {
    ...
    useEffect(() => {
        ...
        fetchDocuments();
    }, [props.params.topicName, currentPage, pageSize])
                    ...
                    <div className="h-full">
                        ...
                        <div className=" h-full border-2 rounded-xl pl-4 pt-4 pr-6">
                            ...
                            <div className="flex items-centers">
                                ...
                                <div className="font-headingText text-blue_5 mb-3 inline-block cursor-pointer" onClick={() => {
                ...
                <div className="flex-1 mt-8  overflow-auto pl-10">
                    <div className="h-[90vh]  pl-10 pt-1 pr-8 mr-10">
                        ...
                        <div className="max-w-[1280px]">
                            <ul className="pl-2 grid grid-cols-[60px_3fr_1fr] mb-4 ">
