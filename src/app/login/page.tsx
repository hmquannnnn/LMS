        ...
        <>
            ...
            <div
                ...
                <form className={"m-auto flex flex-col"} onSubmit={handleLogIn}>
                    ...
                    <button className={"bg-rose-100 rounded py-1.5 font-medium mb-4"} type="submit">Log in</button>
                ...
                {/*    <input type="submit" />*/}
                {/*</form>*/}
                <p>Don't have an account? <Link className={"text-blue-700"} href={paths.register}>Register</Link></p>
            </div>
            {/*</div>*/}
