    ...
    <>
      <div className="m-auto w-5/6 lg:w-1/4 sm:w-1/2 shadow px-2 py-3 absolute top-[10%] right-1/2 translate-x-2/4 rounded">
        ...
        <form className={"m-auto flex flex-col"} onSubmit={handleLogIn}>
          ...
          <input
            className={"border-[1px] pl-4 rounded py-1.5 mb-4 placeholder:text-gray-500 placeholder:font-thin"}
            type="text"
            name="firstName"
          ...
          <input className={"border-[1px] pl-4 rounded py-1.5 mb-4  placeholder:text-gray-500 placeholder:font-thin"} placeholder="Email" type={"email"} name={"email"} />
          {/* <input className={"border-[1px] pl-4 rounded py-1.5 mb-4"}
            type={"date"}
            name={"dateOfBirth"}
            placeholder="01/10/1990" /> */}
          <label className="ml-2 mb-1">Date of Birth</label>
          <DatePicker className={"border - [1px] pl-4 rounded py-1.5 mb-4 placeholder:text-gray-500 placeholder:font-thin"}
          ...
          <div className={"pl-1 columns-3"}>
            ...
            <div className={"w-1/4 columns-2"}>
              ...
              <label className="cursor-pointer" htmlFor="student" defaultChecked >Student</label>
            </div>
            <div className={"w-1/4 columns-2"}>
              <input type={"radio"} id={"teacher"} name={"role"} value={ROLE_TEACHER} />
        ...
        <p>
          Already have an account? <Link className="underline" href={paths.logIn}>Log in</Link>
        </p>
      </div>
    </>
  );
